...
public class OrderListAdapter extends BaseAdapter implements Filterable {
    ...
    private List<PoDetailDao> originalDetailList;
    private ItemFilter mFilter = new ItemFilter();
    private OnDataUpdatedListener mCallback;

    public OrderListAdapter(OnDataUpdatedListener mCallback) {
    ...
    public void setListDetail(List<PoDetailDao> detailList) {
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<PoDetailDao> list = originalDetailList;
            ...
            final List<PoDetailDao> nlist = new ArrayList<>(count);

            PoDetailDao filterableString;
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            detailList = (List<PoDetailDao>) results.values;
            notifyDataSetChanged();
        }
