...
public class SecondActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(OrderFragment.newInstance(), "ONE");
        adapter.addFragment(ProductFragment.newInstance(), "TWO");
        adapter.addFragment(ProductFragment.newInstance(), "THREE");
